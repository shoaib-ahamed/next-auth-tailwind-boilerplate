...
<div id="toast-message-cta" className="p-2 w-full max-w-xs text-white  rounded-lg shadow  bg-winterSky " role="alert">
    <div className="flex">
        ...
        <div className="ml-3 text-sm font-normal">
            ...
            <div className="inline-flex w-full px-2.5 py-1.5 text-xs font-medium text-center text-white bg-winterSky rounded-lg hover:bg-bluetiful focus:ring-4 focus:outline-none focus:ring-blue-300">{msg.msg}</div>   
        </div>
